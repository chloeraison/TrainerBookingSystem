        ...
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.Clients.Any())
            {
                context.Clients.AddRange(
                    new Client { Name = "Ash Ketchum",       Gym = "Pallet Town Gym", PreferredTime = "Morning",   SessionsLeft = 10 },
                    new Client { Name = "Tony Stark",         Gym = "Stark Tower",     PreferredTime = "Evening",   SessionsLeft = 8  },
                    new Client { Name = "SharkMan, The",      Gym = "Ocean",           PreferredTime = "Afternoon", SessionsLeft = 12 },
                    new Client { Name = "That banana guy 🍌", Gym = "Fruit Gym",       PreferredTime = "Morning",   SessionsLeft = 5  },
                    new Client { Name = "Chloe Kelly",        Gym = "Etihad Campus",   PreferredTime = "Evening",   SessionsLeft = 15 }
                );
                context.SaveChanges();
            }
